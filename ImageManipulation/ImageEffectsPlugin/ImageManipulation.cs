...
namespace ImageEffectsPlugin
{
    public class ImageManipulation : IImageManipulationPlugin
    {
        public string Name {
            get { return "Radius and Resize"; }
            set { }
        }
        ...
        private Image CreateRoundedCorner(Image image, RoundRectanglePosition roundCorner)
        {
        ...
        /// 目标图片的圆角位置  
        /// </summary>  
        private enum RoundRectanglePosition
        {
            /// <summary>  
            /// 左上角  
            /// </summary>  
        ...
        private GraphicsPath CreateRoundRectanglePath(Rectangle rect, int radius, RoundRectanglePosition rrPosition)
        {
