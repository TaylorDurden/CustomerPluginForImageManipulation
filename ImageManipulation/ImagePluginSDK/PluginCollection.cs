...
namespace ImagePluginSDK
{
    ...
    public class PluginCollection : CollectionBase
    {
        ...
        public PluginCollection(IImageManipulationPlugin[] value)
        {
            this.AddRange(value);
        }
        ...
        /// </para>
        /// </summary>
        public IImageManipulationPlugin this[int index]
        {
            get { return ((IImageManipulationPlugin)(this.List[index])); }
        }
        ...
        public void AddRange(IImageManipulationPlugin[] value)
        {
        ...
        public void AddRange(PluginCollection value)
        {
            ...
            {
                this.Add((IImageManipulationPlugin)value.List[i]);
            }
        }
        ...
        public void CopyTo(IImageManipulationPlugin[] array, int index)
        {
        ...
        public class PluginCollectionEnumerator : IEnumerator
        {
            ...
            /// </summary>
            public IImageManipulationPlugin Current
            {
                get { return ((IImageManipulationPlugin)(_enumerator.Current)); }
            }
